...
var _typelessSttJs = require("typeless-stt-js");
...
const audioRecorder = new (0, _typelessSttJs.AudioRecorder)(onNewResult, "wss://speech.typeless.ch/real-time-transcription/", "fr", [
    "hotword1",
    "hotword2"
], onStop, true // Manual punctuation
);
...
},{"typeless-stt-js":"4YnUg"}],"4YnUg":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.AudioRecorder = void 0;
var AudioRecorder_1 = require("5b45b6c630253f3");
Object.defineProperty(exports, "AudioRecorder", {
    enumerable: true,
    get: function() {
        return AudioRecorder_1.AudioRecorder;
    }
});

},{"5b45b6c630253f3":"aPvrN"}],"aPvrN":[function(require,module,exports) {
"use strict";
...
exports.AudioRecorder = void 0;
const WebsocketManager_1 = require("4b3d7c0c102db0b1");
class AudioRecorder {
    ...
    startRecording(callKey) {
        return __awaiter(this, void 0, void 0, function*() {
            if (this.currentlyStopping) return {
                microphoneLabel: "",
                error: "already_stopping"
            };
            if (this.currentlyStarting) return {
                microphoneLabel: "",
    ...
    stopRecording() {
        return __awaiter(this, void 0, void 0, function*() {
            if (this.currentlyStopping || this.currentlyStarting) return "already_processing";
            this.currentlyStopping = true;
            const res = this.webSocketManager ? yield this.webSocketManager.stop() : "not_started";
            this.webSocketManager = null;
            this.currentlyStopping = false;
            this.currentlyRecording = false;
            return res;
    ...
    cleanup() {
        if (this.currentlyRecording) this.stopRecording();
    }
}
exports.AudioRecorder = AudioRecorder;

},{"4b3d7c0c102db0b1":"fnr7D"}],"fnr7D":[function(require,module,exports) {
"use strict";
var __awaiter = this && this.__awaiter || function(thisArg, _arguments, P, generator) {
    function adopt(value) {
        return value instanceof P ? value : new P(function(resolve) {
...
const RecordAudio_1 = require("d2ddb8636b30cb9f");
...
class WebsocketManager {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            try {
                ...
                this.audioSocket.onopen = ()=>{
                    if (this.audioSocket) this.audioSocket.send(JSON.stringify({
                ...
                this.audioSocket.onmessage = (event)=>{
                    ...
                    if ("finished" in message) {
                        ...
                        // Call onStop
                        if (this.finalBlob) this.onStop(this.finalBlob, this.callKey);
                        else {
                    ...
                    if ("transcript" in message) // Add call key to all transcripts
                    for(let i = 0; i < message.transcript.length; i++)message.transcript[i].callKey = this.callKey;
                    (_a = this.onResult) === null || _a === void 0 || _a.call(this, message);
                };
                this.audioRecorder.addEventListener("dataavailable", (data)=>__awaiter(this, void 0, void 0, function*() {
                        ...
                        if (!this.audioSocket || this.audioSocket.readyState === 0) return;
    ...
    stop() {
        return __awaiter(this, void 0, void 0, function*() {
            if (this.stopping) return "already_stopping";
            this.stopping = true;
            if (this.starting) // Wait for start to finish
            while(this.starting)yield new Promise((r)=>setTimeout(r, 100));
...
},{"d2ddb8636b30cb9f":"ayb1X"}],"ayb1X":[function(require,module,exports) {
"use strict";
...
class RecordAudio {
    ...
    pause() {
        ...
        this.isPaused = true;
        // Pause the recording
        (_a = this.recordRTC) === null || _a === void 0 || _a.pauseRecording();
    }
    resume() {
        var _a;
        this.isPaused = false;
        // Resume the paused recording
        (_a = this.recordRTC) === null || _a === void 0 || _a.resumeRecording();
    }
    start(timeslice = 1000, sampleRate = 16000) {
        return __awaiter(this, void 0, void 0, function*() {
            try {
                const { default: { RecordRTCPromisesHandler, StereoAudioRecorder } } = yield Promise.resolve().then(function() {
                    return require("69b664932c7242d5");
                ...
                const recorderConfig = {
                    ...
                    ondataavailable: (blob)=>__awaiter(this, void 0, void 0, function*() {
                            ...
                            event.data = this.isPaused ? new Blob([], {
                                type: "audio/wav"
                            }) : blob;
    ...
    stop() {
        ...
        return __awaiter(this, void 0, void 0, function*() {
            ...
            (_c = this.stream) === null || _c === void 0 || _c.getAudioTracks().forEach((track)=>track.stop());
        });
    }
...
},{"69b664932c7242d5":"5bZG5"}],"5bZG5":[function(require,module,exports) {
module.exports = require("3ab793107fb0dcf2")(require("6f09fa064ed1102").getBundleURL("UckoE") + "RecordRTC.b753ec82.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("3bFcc"));

},{"3ab793107fb0dcf2":"61B45","6f09fa064ed1102":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
...
},{}]},["3QC3y","bB7Pu"], "bB7Pu", "parcelRequirefc40")
